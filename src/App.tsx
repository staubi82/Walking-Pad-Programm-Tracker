...
import { saveTrainingSession, getTrainingSessions, deleteTrainingSession } from './firebase/services';
...
function App() {
  ...
  const handleSaveEditedSession = async (updatedSession: TrainingSession) => {
    try {
      if (firebaseConfigured) {
        // Hier würde normalerweise eine updateTrainingSession Funktion aufgerufen
        // Da wir keine Update-Funktion haben, löschen wir die alte und erstellen eine neue
        await deleteTrainingSession(updatedSession.id);
          ...
          <div className="flex justify-between items-center h-16">
            ...
            {!firebaseConfigured && (
              <div className="flex items-center space-x-2 text-yellow-400">
                ...
                <span className="text-sm">Firebase nicht konfiguriert - lokale Speicherung aktiv</span>
              </div>
            )}
          </div>
        </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            <div className="bg-gray-800 rounded-xl p-6 shadow-xl">
              <h2 className="text-2xl font-bold text-white mb-6">Willkommen beim Walking-Pad Tracker</h2>
