...
import { Eye, EyeOff, Mail, Lock, User, UserPlus, Activity } from 'lucide-react';
import { registerUser, loginWithGoogle, loginWithFacebook, loginWithGithub, getAuthErrorMessage } from '../../firebase/auth';
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-400">Starten Sie Ihre Fitness-Reise noch heute</p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-800 text-gray-400">Oder registrieren mit</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-600 rounded-lg bg-gray-700 text-sm font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
